...
import '../../../controller/bimbingan_dosen_controller.dart';

class BimbinganPageDosen extends StatefulWidget {
  const BimbinganPageDosen({Key? key}) : super(key: key);

  @override
  State<BimbinganPageDosen> createState() => _BimbinganPageDosenState();
}

class _BimbinganPageDosenState extends State<BimbinganPageDosen> {
  final firestore = FirebaseFirestore.instance;
  final storage = new FlutterSecureStorage();
  final textController = Get.find<TextController>();
  final bimbinganDosenController = Get.find<BimbinganDosenController>();
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getChatsData(String nip) async* {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: getChatsData(textController.nipDosen.value),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      ...
                      bimbinganDosenController.goToChatRoom(
                        chat['chat_id'],
                        chat['name'],
                        chat['connection'],
